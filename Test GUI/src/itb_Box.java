...
public class itb_Box {
	 ...
	 */
	public void drawBounds(  Graphics2D painting, int inX, int inY,  int outlineThickness ) //A special function used when the mouse is being dragged to give a representation of the box
	{
		...
		*/
		...
		// draw the thing.
		painting.drawRect(startX, startY, recWidth, recHeight);
